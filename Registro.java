...
public class Registro extends JFrame {
    ...
    public Registro() {
        ...
        Opcion2.setBounds(195, 184, 100, 20);
        ...
        JLabel lblNewLabel = new JLabel("Preferenicias");
        lblNewLabel.setBounds(160, 161, 79, 14);
        ...
        Acceder.addActionListener(e -> {
            ...
            if (u && p) JOptionPane.showMessageDialog(this, "Login correcto");
        });
        ...
        Crear.addActionListener(e -> {
            ...
            Terminos.setForeground(t ? Color.BLACK : Color.RED);

            if (u && p && b && pref && t) JOptionPane.showMessageDialog(this, "Registro exitoso");
        });
    }
}